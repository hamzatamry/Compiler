...
typedef enum 
{
    NUM_ERR, CHAR_ERR, FICH_VID_ERR, ID_LONG_ERR, ID_INC_ERR, COMMENT_ERR, STRINGVAL_ERR,
    ...
    RETURN_ERR,EQU_ERR,TO_ERR,INTERROGATION_ERR,ELIF_ERR,COMPARATOR_ERR, DIFF1_ERR
} ERREURS;
