...
const char tokens[][20] = {  
    ...
    "log", "fprintf", "fscanf", "fread", "fwrite", "puts", "gets", "call","STRINGVAL", "LE RESTE", "CHAR_VALUE", "?", "to"                               
};
...
const char lexical_unit[][20] = {
    ...
    "PUTS_TOKEN", "GETS_TOKEN","CALL_TOKEN", "STRINGVAL_TOKEN", "ERREUR_TOKEN", "CHAR_VALUE_TOKEN","INTERROGATION_TOKEN", "TO_TOKEN"
};
